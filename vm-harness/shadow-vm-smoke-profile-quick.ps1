        ...
        Send-AgentCommand -Command "agent audit.events 7" -ExpectedMarker "RAIOS_AGENT_END memory.recent_events"
        ...
        if ($envelopeAuditEvents.Count -ne 4) {
            throw "Expected four agent command envelope audit events"
        }
