function Invoke-ProviderContextGateSelftestProfile {
    ...
    Add-Predicate -Name "protocol:provider_context_injection_gate_v1_denial" -Expected "v1 injection denial binds final authorization and all policy hashes" -Passed $providerContextInjectionGateOk -Actual ($providerContextInjectionGate | ConvertTo-Json -Compress -Depth 12)
