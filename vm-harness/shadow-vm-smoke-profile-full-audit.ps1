function Assert-ModuleLoadAuditBindingContains {
    param(
        [string]$Name,
        [string]$Needle
    )

    $passed = $null -ne $moduleLoadAuditBindingLine -and $moduleLoadAuditBindingLine.Contains($Needle)
    Add-Predicate -Name $Name -Expected "module_load_audit_binding_contains:$Needle" -Passed $passed -Actual $(if ($passed) { "found" } else { "binding field missing" })
    if (-not $passed) {
        throw "Expected module.load_ephemeral audit binding to contain '$Needle'"
    }
}
    ...
    $moduleLoadAuditBindingLine = ((Get-SerialLogContent -Path $SerialLog) -split '[\r\n]+' | Where-Object { $_.Contains('"binding": {"record_schema": "raios.module_load_gate.v0"') } | Select-Object -Last 1)
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_module_manifest_evidence" -Needle '"id": "module_manifest", "kind": "retained_reference", "status": "verified", "reason": "retained_module_manifest_reference_not_authorizing"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_candidate_artifact_evidence" -Needle '"id": "candidate_artifact", "kind": "retained_reference", "status": "verified", "reason": "retained_candidate_artifact_reference_not_authorizing"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_local_approval_evidence" -Needle '"id": "local_approval", "kind": "retained_reference", "status": "verified", "reason": "retained_local_approval_reference_not_authorizing"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_computed_grant_evidence" -Needle '"id": "computed_capability_grant", "kind": "retained_reference", "status": "verified", "reason": "retained_computed_grant_reference_not_authorizing"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_vm_test_report_evidence" -Needle '"id": "vm_test_report", "kind": "retained_reference", "status": "verified", "reason": "retained_vm_test_report_reference_not_authorizing"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_local_attestation_evidence" -Needle '"id": "local_attestation", "kind": "retained_reference", "status": "verified", "reason": "retained_local_attestation_reference_not_authorizing"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_durable_audit_record_evidence" -Needle '"id": "durable_audit_record", "kind": "retained_reference", "status": "verified", "reason": "durable_audit_write_missing"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_rollback_plan_evidence" -Needle '"id": "rollback_plan", "kind": "retained_reference", "status": "verified", "reason": "rollback_install_missing"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_service_slot_evidence" -Needle '"id": "service_slot", "kind": "retained_reference", "status": "verified", "reason": "retained_service_slot_reservation_not_allocated"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_service_slot_allocator_evidence" -Needle '"id": "service_slot_allocator", "kind": "readiness", "status": "present", "reason": "service_slot_allocator_authority_boundary_non_authorizing"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_service_slot_allocator_schema" -Needle '"record_schema": "raios.module_service_slot_allocator_readiness.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_service_slot_allocator_authority_schema" -Needle '"allocator_authority_boundary": {"record_schema": "raios.module_service_slot_allocator_authority.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_service_slot_allocation_intent_schema" -Needle '"allocation_intent_boundary": {"record_schema": "raios.service_slot_allocation_intent.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_policy_decision_schema" -Needle '"policy_decision": {"record_schema": "raios.service_slot_allocator_policy_decision.v0"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_registry_write_schema" -Needle '"registry_write_authority": {"record_schema": "raios.service_slot_registry_write_authority.v0"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_contract_schema" -Needle '"loader_runtime_contract": {"record_schema": "raios.module_loader_runtime_contract.v0"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_health_monitor_schema" -Needle '"health_monitor_binding": {"record_schema": "raios.service_health_monitor_binding.v0"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_cleanup_authority_schema" -Needle '"unload_cleanup_authority": {"record_schema": "raios.service_unload_cleanup_authority.v0"'
    Assert-LogContains -Name "protocol:module_load_audit_authority_decision" -Needle '"authority_decision": {' -TimeoutSeconds 1
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_authority_decision_schema" -Needle '"authority_decision": {"record_schema": "raios.module_service_slot_allocator_authority_decision.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_registry_commit_gate_schema" -Needle '"registry_write_commit_gate": {"record_schema": "raios.service_slot_registry_write_commit_gate.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_evidence" -Needle '"id": "loader_runtime", "kind": "readiness", "status": "present", "reason": "service_slot_allocator_authority_boundary_non_authorizing"'
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_schema" -Needle '"record_schema": "raios.module_loader_runtime_readiness.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_execution_commit_gate" -Needle '"execution_commit_gate": {"record_schema": "raios.module_loader_runtime_execution_commit_gate.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_descriptor_intake_boundary" -Needle '"descriptor_intake_boundary": {"record_schema": "raios.module_loader_descriptor_intake_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_artifact_byte_intake_boundary" -Needle '"artifact_byte_intake_boundary": {"record_schema": "raios.module_loader_artifact_byte_intake_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_execution_authorization_boundary" -Needle '"execution_authorization_boundary": {"record_schema": "raios.module_loader_execution_authorization_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_service_registry_mutation_boundary" -Needle '"service_registry_mutation_boundary": {"record_schema": "raios.module_loader_service_registry_mutation_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_load_attempt_boundary" -Needle '"load_attempt_boundary": {"record_schema": "raios.module_loader_load_attempt_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_artifact_load_boundary" -Needle '"artifact_load_boundary": {"record_schema": "raios.module_loader_artifact_load_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_mapping_boundary" -Needle '"executable_mapping_boundary": {"record_schema": "raios.module_loader_executable_mapping_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_entrypoint_transfer_boundary" -Needle '"entrypoint_transfer_boundary": {"record_schema": "raios.module_loader_entrypoint_transfer_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_service_start_boundary" -Needle '"service_start_boundary": {"record_schema": "raios.module_loader_service_start_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_service_health_binding_boundary" -Needle '"service_health_binding_boundary": {"record_schema": "raios.module_loader_service_health_binding_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_service_running_state_boundary" -Needle '"service_running_state_boundary": {"record_schema": "raios.module_loader_service_running_state_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_service_start_audit_boundary" -Needle '"service_start_audit_boundary": {"record_schema": "raios.module_loader_service_start_audit_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_service_unload_cleanup_boundary" -Needle '"service_unload_cleanup_boundary": {"record_schema": "raios.module_loader_service_unload_cleanup_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_live_load_commit_boundary" -Needle '"live_load_commit_boundary": {"record_schema": "raios.module_loader_live_load_commit_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_commit_audit_boundary" -Needle '"commit_audit_boundary": {"record_schema": "raios.module_loader_commit_audit_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_commit_rollback_boundary" -Needle '"commit_rollback_boundary": {"record_schema": "raios.module_loader_commit_rollback_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_commit_result_boundary" -Needle '"commit_result_boundary": {"record_schema": "raios.module_loader_commit_result_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_descriptor_acceptance_authority_boundary" -Needle '"descriptor_acceptance_authority_boundary": {"record_schema": "raios.module_loader_descriptor_acceptance_authority_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_descriptor_parser_contract_boundary" -Needle '"descriptor_parser_contract_boundary": {"record_schema": "raios.module_loader_descriptor_parser_contract_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_descriptor_parser_result_boundary" -Needle '"descriptor_parser_result_boundary": {"record_schema": "raios.module_loader_descriptor_parser_result_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_descriptor_schema_validation_boundary" -Needle '"descriptor_schema_validation_boundary": {"record_schema": "raios.module_loader_descriptor_schema_validation_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_descriptor_capability_validation_boundary" -Needle '"descriptor_capability_validation_boundary": {"record_schema": "raios.module_loader_descriptor_capability_validation_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_descriptor_load_plan_boundary" -Needle '"descriptor_load_plan_boundary": {"record_schema": "raios.module_loader_descriptor_load_plan_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_load_plan_authority_boundary" -Needle '"executable_load_plan_authority_boundary": {"record_schema": "raios.module_loader_executable_load_plan_authority_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_load_plan_result_boundary" -Needle '"executable_load_plan_result_boundary": {"record_schema": "raios.module_loader_executable_load_plan_result_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_image_layout_boundary" -Needle '"executable_image_layout_boundary": {"record_schema": "raios.module_loader_executable_image_layout_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_page_mapping_plan_boundary" -Needle '"executable_page_mapping_plan_boundary": {"record_schema": "raios.module_loader_executable_page_mapping_plan_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_page_mapping_boundary" -Needle '"executable_page_mapping_boundary": {"record_schema": "raios.module_loader_executable_page_mapping_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_descriptor_executable_page_binding_boundary" -Needle '"descriptor_executable_page_binding_boundary": {"record_schema": "raios.module_loader_descriptor_executable_page_binding_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_entrypoint_binding_boundary" -Needle '"executable_entrypoint_binding_boundary": {"record_schema": "raios.module_loader_executable_entrypoint_binding_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_entrypoint_transfer_authorization_boundary" -Needle '"executable_entrypoint_transfer_authorization_boundary": {"record_schema": "raios.module_loader_executable_entrypoint_transfer_authorization_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_entrypoint_transfer_boundary" -Needle '"executable_entrypoint_transfer_boundary": {"record_schema": "raios.module_loader_executable_entrypoint_transfer_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_entrypoint_handoff_boundary" -Needle '"executable_entrypoint_handoff_boundary": {"record_schema": "raios.module_loader_executable_entrypoint_handoff_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_runtime_executable_entrypoint_invocation_boundary" -Needle '"executable_entrypoint_invocation_boundary": {"record_schema": "raios.module_loader_executable_entrypoint_invocation_boundary.v0"'
    ...
    Assert-ModuleLoadAuditBindingContains -Name "protocol:module_load_audit_loader_evidence" -Needle '"id": "loader", "kind": "availability", "status": "unavailable", "reason": "module_loader_unimplemented"'
