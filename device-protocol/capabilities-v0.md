...
The read-only `module.artifact_diagnostic` method can inspect the canonical
`raios.module_candidate_artifact_reference.v0` hash reference without accepting
artifact bytes or unsigned service code. A valid reference is retained as a
