...
(function () {
  ...
  const MOBILE_SCROLL_TRIGGER_FRAME_Y = 0.18;
  const MOBILE_SCROLL_TRIGGER_FRAME_Y_PER_CAMERA_DISTANCE = 0.12;
  const MOBILE_SCROLL_TRIGGER_FRAME_Y_MAX = 0.34;
  const MOBILE_SCROLL_TRIGGER_VIEWPORT_Y = 0.38;
  const MOBILE_SCROLL_TRIGGER_TOLERANCE = 0.06;
  const MOBILE_SCROLL_PAGE_TRAVEL_VH = 0.20;
