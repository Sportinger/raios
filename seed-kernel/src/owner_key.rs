...
pub struct HardwareBindingSnapshot {
    ...
    pub tpm2_status_read_plan_available: bool,
    pub tpm2_status_register_kind: &'static str,
    pub tpm2_status_register_phys: u64,
    pub tpm2_status_register_width_bytes: u8,
    pub tpm2_status_read_plan_reason: &'static str,
...
impl HardwareBindingSnapshot {
    const fn not_probed() -> Self {
        Self {
            ...
            tpm2_status_read_plan_reason: "not_probed",
            status: "not_probed",
            reason: "not_probed",
        }
    }
...
fn hardware_binding_from_acpi_probe(probe: iommu_vtd::AcpiTableProbe) -> HardwareBindingSnapshot {
    ...
    HardwareBindingSnapshot {
        ...
        tpm2_status_read_plan_available: details.status_read_plan.available,
        tpm2_status_register_kind: details.status_read_plan.register_kind,
        tpm2_status_register_phys: details.status_read_plan.register_phys,
        tpm2_status_register_width_bytes: details.status_read_plan.register_width_bytes,
        tpm2_status_read_plan_reason: details.status_read_plan.reason,
        status,
        reason: probe.reason,
    }
}
