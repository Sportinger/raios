...
mod agent_protocol_recovery_artifact_reference_emit;
mod agent_protocol_recovery_artifact_selftest_emit;
mod agent_protocol_recovery_artifact_types;
mod agent_protocol_recovery_command_admission_emit;
mod agent_protocol_recovery_command_admission_eval;
mod agent_protocol_recovery_command_authorization_types;
mod agent_protocol_recovery_command_body_emit;
...
mod agent_protocol_recovery_lifeline_command_vocabulary_eval;
mod agent_protocol_recovery_lifeline_eval;
mod agent_protocol_recovery_lifeline_protocol_emit;
mod agent_protocol_recovery_lifeline_protocol_eval;
mod agent_protocol_recovery_lifeline_protocol_types;
mod agent_protocol_recovery_load_binding;
mod agent_protocol_recovery_load_binding_emit;
mod agent_protocol_recovery_loader_runtime_emit;
mod agent_protocol_recovery_loader_runtime_eval;
mod agent_protocol_recovery_memory_provenance_emit;
mod agent_protocol_recovery_memory_provenance_eval;
mod agent_protocol_recovery_memory_write_emit;
mod agent_protocol_recovery_methods;
mod agent_protocol_recovery_persistence_emit;
mod agent_protocol_recovery_persistence_eval;
mod agent_protocol_recovery_rollback_apply_emit;
mod agent_protocol_recovery_rollback_preview_emit;
mod agent_protocol_recovery_rollback_transaction_emit;
mod agent_protocol_recovery_rollback_transaction_eval;
mod agent_protocol_recovery_runtime_types;
mod agent_protocol_recovery_service_inventory_effect_emit;
mod agent_protocol_recovery_status_handler_emit;
