...
pub(crate) const HELLO_SERVICE_LIFECYCLE_EVIDENCE: &[&str] = &[
    ...
    "descriptor_source_signature_verified",
    "artifact_identity_hash",
    "artifact_identity_signature_envelope",
    "artifact_identity_signature_verified",
    "artifact_content_binding_hash",
    "artifact_content_trust_signature_verified",
    "artifact_reference_hash",
    "artifact_bytes_sha256",
    "artifact_reference_trust_signature_verified",
...
pub(crate) const HELLO_RECOVERY_ROLLBACK_INSPECT_SOURCE_REFERENCE_EVIDENCE: &[&str] = &[
    "raios.recovery_rollback_inspect_source_reference.v0",
    "recovery_rollback_inspect_read_event_id",
    "target_region_sector_inspection_hash",
    "append_sector_plan_hash",
    "target_region_write_readback_hash",
    "ram_audit_retention",
    "non_authorizing_source_reference",
];
pub(crate) const HELLO_RECOVERY_ROLLBACK_MATERIALIZE_DRY_RUN_EVIDENCE: &[&str] = &[
    "raios.recovery_rollback_materialize_dry_run.v0",
    "current_boot_test_infrastructure",
    "target_region_write_readback_dry_run",
    "durable_media_write_not_authorized",
    "rollback_apply_not_attempted",
];
pub(crate) const HELLO_SERVICE_ROLLBACK_APPLY_EVIDENCE: &[&str] = &[
    ...
    "rollback_transaction_preflight_hash",
    "raios.ram_only_hello_service_rollback_write_authority_gate.v0",
    "rollback_write_authority_gate_hash",
    "raios.ram_only_hello_service_rollback_append_intent_gate.v0",
    "rollback_append_intent_gate_hash",
    "raios.ram_only_hello_service_rollback_payload_envelope_gate.v0",
    "rollback_payload_envelope_gate_hash",
    "rollback_payload_hash",
    "rollback_payload_provenance_hash",
    "raios.ram_only_hello_service_rollback_transaction_writer_storage_authority_gate.v0",
    "rollback_transaction_writer_storage_authority_gate_hash",
    "raios.module_audit_rollback_append_contract.v0",
    "rollback_transaction_writer_storage_foundation_owner",
    "rollback_transaction_writer_storage_authority",
    "rollback_transaction_writer_storage_audit_target",
    "rollback_transaction_writer_storage_append_target",
    "rollback_transaction_writer_storage_transaction_writer_owner",
    "rollback_transaction_writer_storage_append_target_owner",
    "rollback_transaction_writer_storage_transaction_writer_readiness",
    "rollback_transaction_writer_storage_block_write_path_gate",
    "rollback_transaction_writer_storage_read_only_block_driver",
    "rollback_transaction_writer_storage_partition_inventory",
    "rollback_transaction_writer_storage_scratch_writer_dry_run",
    "rollback_transaction_writer_storage_scratch_target_range",
    "rollback_transaction_writer_storage_append_record_dry_run",
    "rollback_transaction_writer_storage_append_record_image_hash",
    "rollback_transaction_writer_storage_append_sector_plan_dry_run",
    "rollback_transaction_writer_storage_append_sector_image_hash",
    "rollback_transaction_writer_storage_append_sector_write_readback_dry_run",
    "rollback_transaction_writer_storage_append_sector_readback_image_hash",
    "raios.ram_only_hello_service_rollback_durable_append_authority_preflight.v0",
    "rollback_transaction_writer_storage_durable_append_authority_preflight",
    "rollback_transaction_writer_storage_durable_append_authority_preflight_hash",
    ...
    "rollback_transaction_writer_storage_durable_writer_policy_preflight",
    "rollback_transaction_writer_storage_durable_writer_policy_preflight_hash",
    ...
    "rollback_transaction_writer_storage_durable_writer_policy_preflight_missing_writer_policy",
    "raios.ram_only_hello_service_rollback_durable_append_transaction_authorization_gate.v0",
    "rollback_transaction_writer_storage_durable_append_transaction_authorization_gate",
    ...
    "rollback_transaction_writer_storage_durable_append_transaction_authorization_gate_missing_append_transaction_authority",
    "raios.ram_only_hello_service_rollback_append_engine_readiness_decision.v0",
    "rollback_transaction_writer_storage_append_engine_readiness_decision",
    ...
    "rollback_transaction_writer_storage_durable_append_authority_preflight_target_region_media_write_policy_preflight",
    "rollback_transaction_writer_storage_durable_append_authority_preflight_target_region_media_write_policy_preflight_hash",
    "rollback_transaction_writer_storage_durable_append_authority_preflight_target_region_media_write_policy_preflight_source_contract",
    "rollback_transaction_writer_storage_durable_append_authority_preflight_target_region_media_write_policy_preflight_missing_authority",
    "raios.ram_only_hello_service_rollback_media_write_authority_gate.v0",
    "rollback_transaction_writer_storage_media_write_authority_gate",
    "rollback_transaction_writer_storage_media_write_authority_gate_hash",
    ...
    "rollback_transaction_writer_storage_media_write_authority_gate_missing_durable_audit_policy",
    "raios.ram_only_hello_service_rollback_durable_append_authority_decision.v0",
    "rollback_transaction_writer_storage_durable_append_authority_decision",
    "rollback_transaction_writer_storage_durable_append_authority_decision_hash",
    "rollback_transaction_writer_storage_durable_append_authority_decision_append_engine_ready",
    "rollback_transaction_writer_storage_durable_append_authority_decision_missing_durable_append_authority",
    "raios.ram_only_hello_service_rollback_durable_audit_policy_decision.v0",
    "rollback_transaction_writer_storage_durable_audit_policy_decision",
    "rollback_transaction_writer_storage_durable_audit_policy_decision_hash",
    "rollback_transaction_writer_storage_durable_audit_policy_decision_media_write_policy_verified",
    "rollback_transaction_writer_storage_durable_audit_policy_decision_missing_durable_audit_policy",
    "raios.ram_only_hello_service_rollback_durable_audit_policy_candidate.v0",
    "rollback_transaction_writer_storage_durable_audit_policy_candidate",
    "rollback_transaction_writer_storage_durable_audit_policy_candidate_hash",
    "rollback_transaction_writer_storage_durable_audit_policy_candidate_source_audit_record_image_hash",
    "rollback_transaction_writer_storage_durable_audit_policy_candidate_available",
    "rollback_transaction_writer_storage_durable_audit_policy_candidate_not_authority",
    "raios.ram_only_hello_service_rollback_durable_audit_policy_acceptance_gate.v0",
    "rollback_transaction_writer_storage_durable_audit_policy_acceptance_gate",
    "rollback_transaction_writer_storage_durable_audit_policy_acceptance_gate_hash",
    ...
    "rollback_transaction_writer_storage_durable_audit_policy_ledger_candidate",
    ...
    "rollback_transaction_writer_storage_durable_audit_policy_ledger_aware_acceptance_result",
    ...
    "rollback_transaction_writer_storage_durable_audit_policy_write_authority_availability",
    ...
    "rollback_transaction_writer_storage_durable_policy_ledger_availability",
    "rollback_transaction_writer_storage_durable_policy_ledger_availability_hash",
    ...
    "rollback_transaction_writer_storage_durable_policy_ledger_availability_dry_run",
    ...
    "rollback_transaction_writer_storage_durable_policy_ledger_availability_dry_run_no_durable_authority",
    "raios.ram_only_hello_service_rollback_durable_audit_policy_availability.v0",
    "rollback_transaction_writer_storage_durable_audit_policy_availability",
    "rollback_transaction_writer_storage_durable_audit_policy_availability_hash",
    ...
    "rollback_transaction_writer_storage_durable_audit_policy_availability_dry_run",
    ...
    "rollback_transaction_writer_storage_durable_audit_policy_availability_dry_run_no_durable_authority",
    "raios.ram_only_hello_service_rollback_durable_append_authority_availability.v0",
    "rollback_transaction_writer_storage_durable_append_authority_availability",
    "rollback_transaction_writer_storage_durable_append_authority_availability_hash",
    ...
    "rollback_transaction_writer_storage_durable_append_authority_availability_dry_run",
    ...
    "rollback_transaction_writer_storage_durable_append_authority_availability_dry_run_no_durable_authority",
    "raios.ram_only_hello_service_rollback_transaction_append_availability_decision.v0",
    "rollback_transaction_writer_storage_transaction_append_availability_decision",
    "rollback_transaction_writer_storage_transaction_append_availability_decision_hash",
    ...
    "rollback_transaction_writer_storage_transaction_append_authority_denial_gate",
    "rollback_transaction_writer_storage_transaction_append_authority_denial_gate_hash",
    ...
    "rollback_transaction_writer_storage_target_region_sector_inspection",
    "rollback_transaction_writer_storage_target_region_sector_inspection_hash",
    ...
    "rollback_transaction_writer_storage_target_region_sector_inspection_verified",
    ...
    "rollback_transaction_writer_storage_target_region_write_readback_dry_run",
    ...
    "rollback_transaction_writer_storage_target_region_write_readback_verified_current_boot",
    "rollback_transaction_writer_storage_target_region_write_readback_no_durable_authority",
    "raios.audit_rollback_target_region_discovery.v0",
    "rollback_transaction_writer_storage_durable_append_authority_preflight_target_region_discovery",
    "rollback_transaction_writer_storage_durable_append_authority_preflight_target_region_available",
    "rollback_transaction_writer_storage_durable_append_authority_preflight_target_region_scratch_rejected",
    "rollback_transaction_writer_storage_durable_append_authority_preflight_missing_writer_facts",
    "rollback_transaction_writer_storage_block_write_path_missing",
    "rollback_transaction_writer_storage_layout_status",
    "rollback_transaction_writer_storage_append_engine_status",
    "rollback_transaction_writer_storage_append_contract_status",
    "rollback_transaction_writer_storage_transaction_envelope_status",
    "hello_state_hash",
    "rollback_apply_source_durable_policy_write_authority_decision_hash",
    "rollback_apply_source_recovery_rollback_inspect_source_reference_hash",
    "rollback_apply_source_durable_policy_write_authority_decision_verified",
    "rollback_apply_source_recovery_rollback_inspect_source_reference_validated",
    "rollback_apply_authority_missing",
    "rollback_transaction_authority_missing",
    "rollback_transaction_append_authority_missing",
    "rollback_transaction_writer_missing",
    "rollback_transaction_writer_storage_authority_missing",
    "durable_audit_write_authority_missing",
    "rollback_store_write_authority_missing",
    "rollback_append_intent_not_available",
    "persistent_install_authority_missing",
    "rollback_apply_not_executed",
    "rollback_transaction_not_written",
...
pub(crate) const PROVIDER_REQUEST_BINDING_EVIDENCE: &[&str] = &[
    ...
    "provider_trust_verifier_decision",
    "provider_write_not_attempted",
];
...
pub(crate) const RECOVERY_LIFELINE_STATUS_EXECUTION_RESULT_EVIDENCE: &[&str] = &[
    "recovery_lifeline_status_execution_result",
    "status_execution_result_hash",
    "retained_recovery_lifeline_status_read_handler_event_id",
    "retained_recovery_lifeline_command_execution_completion_denial_event_id",
    "command_id",
    "argument_schema",
    "argument_hash",
    "target_locator",
...
pub(crate) const MODULE_LOADER_EXECUTABLE_ENTRYPOINT_TRANSFER_BOUNDARY_SOURCE_EVIDENCE: &[&str] = &[
...
pub(crate) const MODULE_LOADER_EXECUTABLE_ENTRYPOINT_HANDOFF_BOUNDARY_SOURCE_EVIDENCE: &[&str] = &[
...
pub(crate) const MODULE_LOADER_EXECUTABLE_ENTRYPOINT_INVOCATION_BOUNDARY_SOURCE_EVIDENCE:
    &[&str] = &[
