...
impl DurableProviderUseReceipt {
    ...
    pub(crate) const fn audit_seq(&self) -> u64 {
        self.audit_seq
    }

    pub(crate) const fn audit_payload_sha256(&self) -> [u8; 32] {
        self.audit_payload_sha256
    }
}
...
pub(super) fn append_provider_use_audit(
    ...
    Ok(DurableProviderUseReceipt {
        ...
        audit_seq: seq,
        audit_payload_sha256: expected_payload_sha256,
    })
}
