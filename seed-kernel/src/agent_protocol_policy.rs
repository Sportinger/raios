...
fn requested_capability_for_read(method: &str) -> &'static str {
        ...
        || method_eq(method, "provider.context_injection_gate_selftest")
    {
        ...
        || method_eq(method, "recovery.loader_diagnostic")
        || method_eq(method, "recovery.loader_diagnostic_selftest")
        || method_eq(method, "recovery.rollback_evidence_diagnostic")
        ...
        || method_eq(method, "recovery.lifeline_command_vocabulary")
        || method_eq(method, "recovery.lifeline_command_vocabulary_selftest")
        || method_eq(method, "recovery.loader_runtime_isolation")
        ...
        || method_eq(method, "recovery.memory_provenance_selftest")
    {
        ...
        || method_eq(method, "module.loader_runtime")
