use crate::{
    agent_protocol_recovery_constants::RECOVERY_ROLLBACK_TRANSACTION_ENGINE_SELFTEST_CASES,
    agent_protocol_recovery_lifeline_command_vocabulary_eval::*,
    agent_protocol_recovery_lifeline_protocol_eval::*,
    agent_protocol_recovery_loader_runtime_eval::*, agent_protocol_recovery_runtime_types::*,
...
pub(crate) fn recovery_rollback_transaction_engine_check(
    status: &'static str,
    reason: &'static str,
...
pub(crate) fn recovery_rollback_transaction_engine_valid_candidate(
) -> RecoveryRollbackTransactionEngineCandidate {
    RecoveryRollbackTransactionEngineCandidate {
...
pub(crate) fn recovery_rollback_transaction_engine_selftest_case(
    name: &'static str,
