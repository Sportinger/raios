...
) -> [ModuleLoadGateLocalAttestationSelfTestCase; MODULE_LOAD_GATE_LOCAL_ATTESTATION_SELFTEST_CASES]
{
    ...
    let valid_vm_report_reference = module_load_gate_test_vm_report_reference(
        manifest_event_id,
        artifact_event_id,
        retained_event_id,
        valid_manifest_reference,
    ...
    let valid_reference = module_load_gate_test_local_attestation_reference(
        manifest_event_id,
        artifact_event_id,
        vm_report_event_id,
        retained_event_id,
        valid_manifest_reference,
        valid_artifact_reference,
        valid_vm_report_reference,
        valid_retained_reference,
    );
    let substituted_reference = module_load_gate_test_local_attestation_reference(
        manifest_event_id,
        artifact_event_id,
        vm_report_event_id,
        retained_event_id,
    ...
    let mismatched_hash_reference = event_log::ModuleLocalAttestationReference {
        attestation_reference_hash: [0x99; 32],
        ..valid_reference
    };

    [
        module_load_gate_attestation_selftest_case(
        ...
        module_load_gate_attestation_selftest_case(
            ...
            module_load_gate_attestation_candidate(
                ...
                vm_report_event_id,
                valid_vm_report_reference,
                module_load_gate_test_event_id(96),
                valid_retained_reference,
            ),
        ),
    ]
...
fn module_load_gate_attestation_selftest_case(
    name: &'static str,
    expected_status: &'static str,
    expected_reason: &'static str,
    candidate: ModuleLoadGateLocalAttestationReferenceCandidate,
) -> ModuleLoadGateLocalAttestationSelfTestCase {
    let actual = evaluate_module_load_gate_local_attestation_candidate(candidate);
    ModuleLoadGateLocalAttestationSelfTestCase {
        name,
        expected_status,
        expected_reason,
...
pub(crate) fn module_load_gate_approval_selftest_cases(
    ...
    let valid_attestation_reference = module_load_gate_test_local_attestation_reference(
        manifest_event_id,
        artifact_event_id,
        vm_report_event_id,
        retained_event_id,
    ...
    let valid_reference = module_load_gate_test_local_approval_reference(
        manifest_event_id,
        artifact_event_id,
        vm_report_event_id,
        ...
        valid_artifact_reference,
        valid_vm_report_reference,
        valid_attestation_reference,
        valid_retained_reference,
    );
    let substituted_reference = module_load_gate_test_local_approval_reference(
        manifest_event_id,
        artifact_event_id,
        vm_report_event_id,
        attestation_event_id,
    ...
    let mismatched_hash_reference = event_log::ModuleLocalApprovalReference {
        approval_reference_hash: [0x99; 32],
        ..valid_reference
    };

    [
        module_load_gate_approval_selftest_case(
        ...
        module_load_gate_approval_selftest_case(
            ...
            module_load_gate_approval_candidate(
                ...
                attestation_event_id,
                valid_attestation_reference,
                module_load_gate_test_event_id(95),
                valid_retained_reference,
            ),
        ),
    ]
...
fn module_load_gate_approval_selftest_case(
    name: &'static str,
    expected_status: &'static str,
    expected_reason: &'static str,
    candidate: ModuleLoadGateLocalApprovalReferenceCandidate,
) -> ModuleLoadGateLocalApprovalSelfTestCase {
    let actual = evaluate_module_load_gate_local_approval_candidate(candidate);
    ModuleLoadGateLocalApprovalSelfTestCase {
        name,
        expected_status,
        expected_reason,
