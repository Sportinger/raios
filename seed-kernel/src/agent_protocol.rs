...
fn emit_module_load_gate_event_binding(binding: event_log::ModuleLoadGateBinding) {
    ...
    raw(", \"vm_test_report\": \"missing\", \"local_attestation\": \"missing\", \"computed_capability_grant\": ");
    ...
    raw("}, {\"gate\": \"vm_test_report\", \"state\": \"missing\", \"reason\": \"vm_test_report_missing\"}, {\"gate\": \"local_attestation\", \"state\": \"missing\", \"reason\": \"local_attestation_missing\"}, {\"gate\": \"computed_capability_grant\", \"state\": ");
    json_str(module_load_gate_computed_grant_state(binding));
    raw(", \"reason\": ");
...
fn emit_module_load_gate_evidence_hashes_compact(binding: event_log::ModuleLoadGateBinding) {
    if let Some(reference) = binding.retained_reference {
        ...
        raw("\"computed_capability_grant_hash\": null, \"vm_test_report_hash\": null, \"local_attestation_hash\": null");
    }
    if let Some(reference) = binding
        .artifact_reference
        .filter(|_| module_load_gate_candidate_artifact_reference_valid(binding))
