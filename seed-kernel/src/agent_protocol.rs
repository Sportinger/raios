...
use crate::{
    ...
    agent_protocol_support::{
        begin_response, crlf, emit_export_gate, emit_inline_string_array, emit_static_string_array,
        end_response, indent, json_current_boot_id, json_event_id, json_event_id_option,
        json_event_sequence, json_opt_str, json_sha256, json_str, method_eq, method_head_eq,
        parse_current_boot_event_id, raw, raw_bool, raw_fmt, raw_line,
    },
    event_log,
