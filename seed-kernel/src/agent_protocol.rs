...
use crate::{
    agent_protocol_support::{
        crlf, current_boot_event_id_str, indent, json_current_boot_id, json_event_id,
...
#[derive(Clone, Copy)]
struct ModuleArtifactReferenceInput<'a> {
    has_reference: bool,
    arity_valid: bool,
    scope: &'a str,
    artifact_reference_hash: Option<[u8; 32]>,
    retained_manifest_reference_event_id: Option<&'a str>,
...
#[derive(Clone, Copy)]
struct ModuleArtifactReferenceCheck<'a> {
    has_reference: bool,
    arity_valid: bool,
    scope: &'a str,
    artifact_reference_hash: Option<[u8; 32]>,
...
struct ModuleArtifactSelfTestCase {
    name: &'static str,
    expected_status: &'static str,
    expected_reason: &'static str,
    actual_status: &'static str,
...
#[derive(Clone, Copy)]
struct ModuleVmReportReferenceInput<'a> {
    has_reference: bool,
    arity_valid: bool,
    scope: &'a str,
    report_reference_hash: Option<[u8; 32]>,
    retained_manifest_reference_event_id: Option<&'a str>,
    retained_artifact_reference_event_id: Option<&'a str>,
    retained_reference_event_id: Option<&'a str>,
    manifest_reference_hash: Option<[u8; 32]>,
    artifact_reference_hash: Option<[u8; 32]>,
    manifest_hash: Option<[u8; 32]>,
...
#[derive(Clone, Copy)]
struct ModuleVmReportReferenceCheck<'a> {
    has_reference: bool,
    arity_valid: bool,
    scope: &'a str,
    report_reference_hash: Option<[u8; 32]>,
...
struct ModuleVmReportSelfTestCase {
    name: &'static str,
    expected_status: &'static str,
    expected_reason: &'static str,
    actual_status: &'static str,
...
#[derive(Clone, Copy)]
struct ModuleServiceSlotReservationInput<'a> {
    has_reference: bool,
    arity_valid: bool,
    scope: &'a str,
    reservation_hash: Option<[u8; 32]>,
    retained_reference_event_id: Option<&'a str>,
    retained_audit_rollback_reference_event_id: Option<&'a str>,
    computed_grant_hash: Option<[u8; 32]>,
    audit_record_hash: Option<[u8; 32]>,
    rollback_plan_hash: Option<[u8; 32]>,
    pre_load_service_inventory_hash: Option<[u8; 32]>,
...
#[derive(Clone, Copy)]
struct ModuleServiceSlotReservationCheck<'a> {
    has_reference: bool,
    arity_valid: bool,
    scope: &'a str,
    reservation_hash: Option<[u8; 32]>,
...
struct ModuleServiceSlotSelfTestCase {
    name: &'static str,
    expected_status: &'static str,
    expected_reason: &'static str,
    actual_status: &'static str,
...
#[derive(Clone, Copy)]
struct ModuleLoadGateArtifactReferenceCandidate {
    scope: &'static str,
    retained: bool,
    schema_ok: bool,
    event_reference: Option<event_log::ModuleCandidateArtifactReference>,
    candidate_reference: Option<event_log::ModuleCandidateArtifactReference>,
    manifest_event_id: Option<event_log::EventId>,
    manifest_reference: Option<event_log::ModuleManifestReference>,
    retained_event_id: Option<event_log::EventId>,
    retained_reference: Option<event_log::ModuleComputedGrantReference>,
}

#[derive(Clone, Copy)]
struct ModuleLoadGateArtifactEvaluation {
    status: &'static str,
    reason: &'static str,
    candidate_artifact_state: &'static str,
    accepted_artifact_hash: bool,
    can_load: bool,
    load_attempted: bool,
}

struct ModuleLoadGateArtifactSelfTestCase {
    name: &'static str,
    expected_status: &'static str,
    expected_reason: &'static str,
    actual_status: &'static str,
    actual_reason: &'static str,
    actual_candidate_artifact_state: &'static str,
    accepted_artifact_hash: bool,
    passed: bool,
}

#[derive(Clone, Copy)]
struct ModuleLoadGateVmReportReferenceCandidate {
    scope: &'static str,
    retained: bool,
    schema_ok: bool,
    ...
    artifact_reference: Option<event_log::ModuleCandidateArtifactReference>,
    retained_event_id: Option<event_log::EventId>,
    retained_reference: Option<event_log::ModuleComputedGrantReference>,
}

#[derive(Clone, Copy)]
struct ModuleLoadGateVmReportEvaluation {
    status: &'static str,
    reason: &'static str,
    vm_test_report_state: &'static str,
    accepted_vm_report_hash: bool,
    can_load: bool,
    load_attempted: bool,
}

struct ModuleLoadGateVmReportSelfTestCase {
    name: &'static str,
    expected_status: &'static str,
    expected_reason: &'static str,
    actual_status: &'static str,
    actual_reason: &'static str,
    actual_vm_test_report_state: &'static str,
    accepted_vm_report_hash: bool,
    passed: bool,
}
...
#[derive(Clone, Copy)]
struct ModuleLoadGateAuditRollbackReferenceCandidate {
    scope: &'static str,
    retained: bool,
    schema_ok: bool,
    event_reference: Option<event_log::ModuleAuditRollbackReference>,
    candidate_reference: Option<event_log::ModuleAuditRollbackReference>,
}
...
const MODULE_ARTIFACT_SELFTEST_CASES: usize = 7;
const MODULE_VM_REPORT_SELFTEST_CASES: usize = 8;
...
const MODULE_LOAD_GATE_ARTIFACT_SELFTEST_CASES: usize = 9;
const MODULE_LOAD_GATE_VM_REPORT_SELFTEST_CASES: usize = 11;
...
const MODULE_ARTIFACT_TEST_RETAINED_MANIFEST_REFERENCE_EVENT_ID: &str =
    "event.current_boot.00000026";
const MODULE_VM_REPORT_TEST_RETAINED_ARTIFACT_REFERENCE_EVENT_ID: &str =
...
fn emit_module_service_slot_diagnostic(method: &str) {
...
fn emit_module_service_slot_diagnostic_selftest() {
...
fn ram_only_service_slot_id_valid(value: &str) -> bool {
    module_evidence::ram_only_service_slot_id_valid(value)
}
...
fn module_service_slot_diagnostic_method(method: &str) -> bool {
