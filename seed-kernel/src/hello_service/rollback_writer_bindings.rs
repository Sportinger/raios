...
pub(crate) fn bind_rollback_write_authority_gate(
    ...
    if let Some(probation) = snapshot.hot_swap_probation {
        ...
        binding.rollback_write_authority_gate_hash =
            Some(rollback_write_authority_gate_hash(snapshot, probation));
...
pub(crate) fn bind_rollback_append_intent_gate(
    ...
    if let Some(probation) = snapshot.hot_swap_probation {
        ...
        binding.rollback_append_intent_gate_hash =
            Some(rollback_append_intent_gate_hash(snapshot, probation));
...
pub(crate) fn bind_rollback_payload_envelope_gate(
    ...
    if let Some(probation) = snapshot.hot_swap_probation {
        ...
        binding.rollback_payload_envelope_gate_hash =
            Some(rollback_payload_envelope_gate_hash(snapshot, probation));
