...
pub(crate) fn rollback_writer_storage_foundation() -> RollbackWriterStorageFoundation {
...
pub(crate) fn rollback_payload_envelope_gate_hash(
    snapshot: Snapshot,
    probation: HelloHotSwapProbationRecord,
) -> [u8; 32] {
    let mut hash = Sha256::new();
...
pub(crate) fn hello_rollback_writer_storage_foundation() -> RollbackWriterStorageFoundation {
    rollback_writer_storage_foundation()
}
