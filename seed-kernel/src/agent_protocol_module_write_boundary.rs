...
fn emit_module_audit_rollback_append_payload_hash_selftest_case(
...
fn module_audit_rollback_append_payload_hash_snapshot_from_binding_and_append_contract(
...
fn module_audit_rollback_append_payload_hash_fact_from_binding(
    binding: event_log::ModuleLoadGateBinding,
    audit_payload: bool,
...
fn module_audit_rollback_missing_append_payload_hash_fact(
) -> ModuleAuditRollbackAppendPayloadHashFact {
    ModuleAuditRollbackAppendPayloadHashFact {
        present: false,
        schema_ok: true,
...
fn module_audit_rollback_available_append_payload_hash_fact(
) -> ModuleAuditRollbackAppendPayloadHashFact {
    ModuleAuditRollbackAppendPayloadHashFact {
        present: true,
        schema_ok: true,
...
fn evaluate_module_audit_rollback_append_payload_hash_candidate(
...
fn evaluate_module_append_payload_hash_fact(
...
fn emit_module_append_payload_retained_inputs(binding: event_log::ModuleLoadGateBinding) {
...
fn emit_module_append_payload_hash_facts(
...
fn emit_module_append_payload_hash_fact(
    name: &'static str,
    schema: &'static str,
    id: &'static str,
    target_schema: &'static str,
...
fn module_audit_rollback_append_payload_hash_selftest_cases(
...
fn module_audit_rollback_append_payload_hash_selftest_case(
    name: &'static str,
    expected_status: &'static str,
    expected_reason: &'static str,
    candidate: ModuleAuditRollbackAppendPayloadHashCandidate,
...
fn module_audit_rollback_append_intent_snapshot_from_append_contract_and_payload(
    append: ModuleAuditRollbackAppendContractEvaluation,
...
fn emit_module_append_intent_payload_hash_inputs(
    payload: ModuleAuditRollbackAppendPayloadHashCandidate,
    evaluation: ModuleAuditRollbackAppendPayloadHashEvaluation,
) {
...
fn emit_module_append_intent_payload_hash_input(
    name: &'static str,
    schema: &'static str,
    fact: ModuleAuditRollbackAppendPayloadHashFact,
    status: &'static str,
...
fn emit_module_write_boundary_append_payload_hash_inputs(
    payload: ModuleAuditRollbackAppendPayloadHashCandidate,
    evaluation: ModuleAuditRollbackAppendPayloadHashEvaluation,
) {
    raw_line("      \"append_payload_hash_inputs\": {");
...
fn emit_module_write_boundary_append_payload_hash_input(
    name: &'static str,
    schema: &'static str,
    fact: ModuleAuditRollbackAppendPayloadHashFact,
    status: &'static str,
