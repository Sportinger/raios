...
`release/vm-reports/shadow-20260524-072218-21216.json` recorded 2725/2725
...
- `cargo fmt --all -- --check` passed after extracting recovery lifeline command
  ...
  artifact selftest emit helpers.
- `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\build-seed-kernel.ps1 -Profile release`
  ...
  command-effect type-surface helpers plus artifact selftest emit helpers.
