...
refactor, recovery method/constant/runtime type-surface extraction, and Shadow VM report
...
live in `seed-kernel/src/agent_protocol_recovery_runtime_types.rs`. The
...
`release/vm-reports/shadow-20260524-002740-26940.json` recorded 2725/2725
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\build-seed-kernel.ps1 -Profile release`
  ...
  helpers plus recovery method/constant/runtime type-surface helpers.
