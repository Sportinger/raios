...
refactor, recovery method/constant/type-surface extraction, and Shadow VM report
evidence cleanup. The recovery lifeline command
...
`seed-kernel/src/agent_protocol_recovery_lifeline_protocol_types.rs`. The
...
`release/vm-reports/shadow-20260524-000922-23768.json` recorded 2725/2725
...
- `cargo fmt --all -- --check` passed after extracting recovery lifeline command
  specs, execution-stage helpers, and recovery method/constant/type-surface
  helpers.
- `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\build-seed-kernel.ps1 -Profile release`
  ...
  helpers plus recovery method/constant/type-surface helpers.
