...
refactor, recovery method/constant/runtime/command-dispatch type-surface
extraction, and Shadow VM report evidence cleanup. The recovery lifeline command
...
`seed-kernel/src/agent_protocol_recovery_command_dispatch_types.rs`. The
...
`release/vm-reports/shadow-20260524-003646-12804.json` recorded 2725/2725
...
- `cargo fmt --all -- --check` passed after extracting recovery lifeline command
  ...
  command-dispatch type-surface helpers.
- `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\build-seed-kernel.ps1 -Profile release`
  ...
  helpers plus recovery method/constant/runtime/command-dispatch type-surface
  helpers.
...
- `powershell -NoProfile -ExecutionPolicy Bypass -File vm-harness\shadow-vm-smoke.ps1 -Profile recovery -TimeoutSeconds 180`
  ...
  `release\vm-reports\shadow-20260524-003646-12804.json` with 2725/2725
