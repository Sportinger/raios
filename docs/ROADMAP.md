...
refactor, recovery method/constant-surface extraction, and Shadow VM report evidence
...
`seed-kernel/src/agent_protocol_recovery_constants.rs`, and the central
dispatcher imports the execution and method wrappers directly from focused
modules. Public method names,
...
`release/vm-reports/shadow-20260523-234000-16188.json` recorded 2725/2725
...
- `cargo fmt --all -- --check` passed after extracting recovery lifeline command
  specs, execution-stage helpers, and recovery method/constant-surface helpers.
- `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\build-seed-kernel.ps1 -Profile release`
  ...
  helpers plus recovery method/constant-surface helpers.
