# AI Build & Test Runbook - Stage-0 raiOS To Stage-1

This is a no-code runbook for AI agents and humans working on the raiOS VM-first
...
Exit: QEMU shows the raiOS UI and serial logs include framebuffer readiness.
