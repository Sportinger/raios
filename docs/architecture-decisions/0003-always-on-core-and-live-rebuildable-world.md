...
## Status
Draft for the long-term SeedOS architecture.

## Context
The Stage-0 MVP currently proves that SeedOS can boot directly into a small
...
## Decision
SeedOS should evolve toward a permanent minimal core plus a live-rebuildable
world above it.
...
SeedOS may still pause, quiesce, restart services, or perform a core-generation
handoff.
